...
public:
    ...
    //Métodos MART
    unsigned pinINT=21;
    void read(long unsigned int &rxId,unsigned char &len,char msgString[]);
    void write(long unsigned int &rxId,unsigned char &len,char msgString[]);
};
